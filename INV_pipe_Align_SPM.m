...
delete([opts.DCENIIDir '/bet*']); delete([opts.DCENIIDir '/rDCE*']); delete('DCE3D*.nii'); delete([opts.DCENIIDir '/meanPre.nii']); delete([opts.DCENIIDir '/*.txt']);
...
spm_file_merge(sort(getMultipleFilePaths([opts.DCENIIDir '/rDCE3D*.nii'])),[opts.DCENIIDir '/rDCE.nii'],0);
